 ...
 *
 */
bool Si5351::init(i2cbus_t *i2c, uint32_t xo_freq, int32_t corr)
{
	uint8_t reg_val;
    m_i2c = i2c;
 ...
 *   (use the si5351_clock enum)
 */
uint8_t Si5351::set_freq_manual(enum si5351_clock clk, uint64_t freq, uint64_t pll_freq)
{
	struct Si5351RegSet ms_reg;
	uint8_t int_mode = 0;
	uint8_t div_by_4 = 0;
 ...
 */
void Si5351::set_output_enable(enum si5351_clock clk, uint8_t enable)
{
  uint8_t reg_val;
 ...
 */
void Si5351::set_output_drive_strength(enum si5351_clock clk, enum si5351_drive drive)
{
    uint8_t reg_val;
 ...
 */
void Si5351::set_output_disable_state(enum si5351_clock clk, enum si5351_clock_output_disable dis_state)
{
...
*
 */
void Si5351::set_clock_r_div(enum si5351_clock clk, enum si5351_clock_r_div r_div)
{
    uint8_t reg_val;
 ...
 */
void Si5351::set_fanout(enum si5351_fanout fanout, uint8_t enable)
{
 ...
 */
void Si5351::set_integer(enum si5351_clock clk, uint8_t enable)
{
	uint8_t reg_val;
	reg_val = read_reg(SI5351_CLK0_CTRL + (uint8_t)clk);
