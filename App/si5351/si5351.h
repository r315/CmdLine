...
public:
	...
	void set_output_drive_strength(enum si5351_clock, enum si5351_drive);
    void set_output_disable_state(enum si5351_clock, enum si5351_clock_output_disable);
    ...
    void set_clock_r_div(enum si5351_clock, enum si5351_clock_r_div);
	void set_fanout(enum si5351_fanout, uint8_t);
    void set_ms_source(enum si5351_clock, enum si5351_pll);
	uint8_t read_reg(uint8_t);
	uint8_t write_reg(uint8_t, uint8_t);
private:
    uint8_t write_reg_bulk(uint8_t, uint8_t *, uint8_t);
	...
	void set_integer(enum si5351_clock, uint8_t);
